...
def download_wind_resource_for_single_site(sitelist,match_id,output_dir,resource_year=2012,lat_string = "parcel_latitude",lon_string="parcel_longitude"):
    lat = sitelist.loc[match_id][lat_string]
    lon = sitelist.loc[match_id][lon_string]
    gid = sitelist.loc[match_id]["WTK gid"]
    hub_height = sitelist.loc[match_id]["hub_height"]
